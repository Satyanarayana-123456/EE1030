    ...
    \item Evaluate:\begin{align*}
	 ...
	 \item Evaluate the following\begin{align*}
	     ...
	     \item Evaluate the following:\begin{align*}
			 ...
			 \item Prove that for any positive integer k, $\frac{\sin{\brak{2kx}}}{\sin{\brak{x}}}=2[\cos{\brak{x}}+\cos{\brak{3x}}+..............+\cos{\brak{2k-1}x}]$\\\\Hence prove that\hfill($1990-4\ Marks$)\\ $\int_{0}^{\pi/2}\sin{\brak{2kx}}\cot{\brak{x}}dx=\pi/2$\\\\
